        ...
        <section className="py-16 bg-gray-900 text-white">
            ...
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 px-6">
                ...
                <div className="w-full md:w-1/2 bg-stone-800 p-6 rounded-lg shadow-lg text-center">
                    ...
                    <a
                        href="https://drive.google.com/file/d/1vnN8rMREX5HEgi2BcJkHswG51_kPy9h5/view?usp=sharing"
                        download
                        target="_blank"
                ...
                <div className="w-full md:w-1/2 bg-stone-800 p-6 rounded-lg shadow-lg text-center">
                    ...
                    <div className="flex flex-col gap-3">
                        <a
                            href="mailto:hs4918824@gmail.com"
                            className="flex items-center justify-center gap-3 text-gray-300 hover:text-blue-400 transition"
                        >
                            <MdEmail size={24} /> hs4918824@gmail.com
                        </a>
                        <a
                            href="https://www.linkedin.com/in/himanshu-sharma-887a57282?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                            target="_blank"
                            rel="noopener noreferrer"
